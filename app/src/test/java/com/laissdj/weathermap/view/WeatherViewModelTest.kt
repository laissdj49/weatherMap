...
//import com.laissdj.weathermap.response.Daily
//import com.laissdj.weathermap.response.Main
//import com.laissdj.weathermap.response.Sys
//import com.laissdj.weathermap.response.Temp
...
//
//    @Test
//    fun `weatherLocation should return WeatherPresentation when repository returns data`() =
//        runTest {
...
//        coEvery { repository.getWeather(any()) } throws HttpException(
//            Response.error<WeatherResponse>(
//                404,
//                "".toResponseBody()
//            )
//        )
